<?php
namespace Cas\Service\Authentication;

use Interop\Container\ContainerInterface;
use Cas\Authentication\CasAdapter;
    ...
    public function __invoke(ContainerInterface $serviceLocator, $requestedName, array $options = null)
    {
        ...
        if (!$status->isInstalled() ||
            ...
            if ($status->isApiRequest()) {
                ...
                $adapter = new CasAdapter($entityManager, $logger, $settings, $eventManager, $config['cas']);
                $adapter->setOptions($config['cas']['adapter_options']);
            }
        }
